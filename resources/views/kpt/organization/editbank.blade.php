...
<div class="row">
  ...
  <div class="col-md-6">
            <form id="form_sms"action="{{ route('admin.Kptorganization.update_bankdetails',[$edit_bank->id])}}" class="needs-validation" novalidate="" method="post" enctype="multipart/form-data">
            @csrf
            <section class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                         ...
                         <input type="text" name="org_id" placeholder="Org Name" class="form-control" value="{{ $kptorganization->org_id }}" hidden> 
