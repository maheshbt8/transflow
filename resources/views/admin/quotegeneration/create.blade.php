        ...
        <div class="col-md-3">
          <div class="form-group {{ $errors->has('') ? 'has-error' : '' }}">
            ...
            <select name="org_adrs" id="org_adrs" class="form-control select2" required onchange="selectaddress(this.value)">
              ...
              <option value="{{$adr->id}}" data-addr="<?php echo $adr->address; ?>"><?php echo $adr->address; ?></option>
              @endforeach
            </select>
            <div class="invalid-feedback" for="">Please Select Client Organization</div>
          </div>
        ...
        <div class="col-md-3">
          <div class="form-group {{ $errors->has('') ? 'has-error' : '' }}">
            ...
            <select name="currency" id="currency" class="form-control select2" required>
              ...
              <option value="{{$cl->id}}" data-currency="{{$cl->currency_code}}">{{$cl->currency_name .' - '. $cl->currency_code}}</option>
              @endforeach
            </select>
          </div>
        </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group hide_price_div" id="resource_price_div_0">
                      <label id="resource_label_0"> Resource Count & Cost Per Resource: *</label>
                      <div class="form-row">
                        <div class="col-md-12"> <input type="number" min="1" max="1000000000" id="resource_words_count_0" name="resource_words_count_0" class="form-control" placeholder="Resource Count" onkeyup="getpercost('resource',0,this.value)"><br></div>
                        <div class="col-md-12"> <input type="text" name="resource_cost_per_word_0" id="resource_cost_per_word_0" class="form-control float-number" placeholder="Cost Per Resource."><br></div>
                        <div class="col-md-12"> <input type="text" name="resource_fixed_cost_0" id="resource_fixed_cost_0" class="form-control float-number" placeholder="fixed cost"></div>
                      </div>
                    </div>
                  </div>
                </div>
