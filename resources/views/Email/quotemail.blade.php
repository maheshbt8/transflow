              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    @if(isset($mailData['quote_url']) && $mailData['quote_url'] != '')
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{$mailData['quote_url']}}" style="color:#ee4c50;text-decoration:underline;" target="_blank">Click Here to</a>  View the Quote</p>
                    @endif
                    @if(isset($mailData['purches_url']) && $mailData['purches_url'] != '')
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{$mailData['purches_url']}}" style="color:#ee4c50;text-decoration:underline;" target="_blank">Click Here  to</a>  Upload/Comment on PO Availability.</p>
                    @endif
