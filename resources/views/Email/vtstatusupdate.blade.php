              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Reference ID: <b>{{$mailData['quote_code']}}</b></p>
                    ...
                    <?php if($mailData['completed_task'] != ''){?>
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Work Progress %: <b>{{$mailData['completed_task']}}</b></p>
                    <?php }?>
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Date: <b>{{$mailData['date']}}</b></p>
                    @if($mailData['request_id'])
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{$mailData['request_id']}}" style="color:#ee4c50;text-decoration:underline;" target="_blank">Click Here</a> to see the Details</p>
                    @endif
                  </td>
                </tr>
                <tr>  
