              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Request Id: <b>{{$mailData['req_id']}}</b></p>
                    <?php if(isset($mailData['client_org_id']) && $mailData['client_org_id'] != '') { ?>
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Reference ID: <b>{{$mailData['client_org_id']}}</b></p>
                    <?php } ?>
                    <?php if(isset($mailData['company_name']) && $mailData['company_name'] != '') { ?>
                    ...
                    @if($mailData['request_url'])
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{$mailData['request_url']}}" style="color:#ee4c50;text-decoration:underline;" target="_blank">Click Here</a> to see the Details</p>
                    @endif
                  </td>
                </tr>
                <tr>  
