...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                ...
                <tbody>			
                    ...
                    @foreach($kptaemkreviewerresults as $key => $row)											
                        <tr>                            
		...
		<div class="xp_col11 actionstoggle_kreviewer" aem_main_request_id="<?php print $row->aem_reference_code;?>"><a href="#" aem_main_request_id="<?php print $row->aem_reference_code;?>" >View Translation(s)</a></div>
...
<script>
 ...
 /* Slide Toggle for actions and options in active dashboard - END */
	$('.actionstoggle_kreviewer').click(function () {
        var aem_main_request_id  = $(this).attr('aem_main_request_id'); 
			
		var accessurl = '{{ route("admin.kptaemkreviewerrequests.aem_request_details_kreviewer") }}';		 
