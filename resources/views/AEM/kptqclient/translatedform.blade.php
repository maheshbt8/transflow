...
?>
		...
		<?php
				 $arr_aem_translated_strings = $kptaemqclient->getting_translated_string_aem_request($aem_reference_code,$aem_object_id,$aem_source_language,$aem_target_language);
