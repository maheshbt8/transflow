        ...
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                ...
                <tbody>			
                    ...
                    @foreach($kptaemqreviewerresults as $key => $row)											
                        <tr>                            
          ...
          <td>		
		<div class="xp_col11 actionstoggle_qreviewer" aem_main_request_id="<?php print $row->aem_reference_code;?>"><a href="#" aem_main_request_id="<?php print $row->aem_reference_code;?>" >Review</a></div>								
		</td>
		</tr>
...
<script>
 ...
 /* Slide Toggle for actions and options in active dashboard - END */
	$('.actionstoggle_qreviewer').click(function () {
        var aem_main_request_id  = $(this).attr('aem_main_request_id'); 
			
		var accessurl = '{{ route("admin.kptaemqreviewerrequests.aem_request_details_qreviewer") }}';		 
