...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                ...
                <tbody>			
                    ...
                    @foreach($kptaemclientpmresults as $key => $row)
		...
		?>
           ...
           <td><a href="#" data-toggle="modal" id="aem_client_pm_view_details" aem_main_request_id="<?php print $row->aem_req_id;?>">View</a>
...
/* View assigned requests from client PM */	
	$(document.body).on('click', "#aem_client_pm_view_details", function(e){       
			var aem_main_request_id  = $(this).attr('aem_main_request_id');
			
			//assigned_aem_request_details

			var accessurl = '{{ route("admin.kptaemcpmrequest.assigned_aem_request_details") }}';
 ...
 /* Slide Toggle for actions and options in active dashboard - END */
	$('.actionstoggle').click(function () {
		...
		var accessurl = '{{ route("admin.kptaemcpmrequest.aem_xmlfiles_request") }}';
